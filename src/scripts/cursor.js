export function initCursor() {
  ...
  const interactives =
    'a, button, .trigger-overlay, input, textarea, select, .sarcastic-quote, .bauhaus-scroll-wrapper, .yt-card, .reel-card, .slide-card';

  document.addEventListener('mouseover', (e) => {
    const interactive = e.target.closest(
      'a, button, .trigger-overlay, input, textarea, select, .sarcastic-quote, .bauhaus-item, .yt-card, .reel-card, .slide-card'
    );
